  ...
  >
    ...
    >
      <div class="relative rounded-md bg-slate-800 p-4">
        ...
        <p>
          Remove this
          <code class="rounded bg-gray-100 p-1 font-mono font-bold dark:bg-white/10">WelcomeComponent</code>
    ...
    >
      <div class="relative rounded-md bg-slate-800 p-4">
        ...
        <p>
          Nuxt is open source and the code is available on GitHub, feel free to star it, participate
          in discussions or dive into the source.
        </p>
      </div>
    </a>
    <a
    ...
    >
      <div class="relative rounded-md bg-slate-800 p-4">
        ...
        <p>
          We highly recommend you take a look at the Nuxt documentation, whether you are new or have
